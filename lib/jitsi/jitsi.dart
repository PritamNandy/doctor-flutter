...
class Jitsi extends StatefulWidget {
  ...
  String s_time;
  String e_time;
  Jitsi({this.link,this.d_name,this.d_date,this.s_time,this.e_time}){
    // print(this.doctor_name);
    print(this.link );
  }
  @override
  JitsiState createState() => JitsiState(this.link,this.d_name,this.d_date,this.s_time,this.e_time);
}
...
class JitsiState extends State<Jitsi> {
  ...
  JitsiState(this.link,this.d_name,this.d_date,this.s_time,this.e_time){
    roomText.text = link;
    subjectText.text = "Appointment " + d_date + " " + s_time + " "+ e_time;
